...
// Menggunakan parameter query untuk menghindari SQL Injection
$koin = ambilData("SELECT koin FROM users WHERE id = :id", ['id' => $id]);

// Ambil latitude dan longitude pengguna dari SESSION
